...
class Odoo
{
     ...
     * @param array            $httpOptions Options to configure the HTTP Client of the XmlRpcClient
     */
    public function __construct($host, $database, $user, $password, $httpOptions = null)
    {
        $this->host = $host;
    ...
    protected function getClient($path = null)
    {
        ...
        if (!empty($this->httpOptions)) {
            $this->client->getHttpClient()->setOptions($this->httpOptions);
        }
